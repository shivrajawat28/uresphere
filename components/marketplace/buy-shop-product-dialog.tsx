...
import { createShopOrderAction } from "@/lib/actions/platform"
...
export function BuyShopProductDialog({ shopProductId, title, priceCents, open, onOpenChange }: Props) {
  ...
  function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    formData.set("shopProductId", shopProductId)
    startTransition(async () => {
      const result = await createShopOrderAction(formData)
